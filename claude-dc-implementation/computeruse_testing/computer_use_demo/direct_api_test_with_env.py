"""
Direct test using the Anthropic API with environment variable.
        ...
        if not api_key:
            ...
            if os.path.exists(secrets_path):
                try:
                    ...
                    logger.error(f"Error loading from secrets file: {str(e)}")
        
        if not api_key:
            logger.error("API key not found in environment or secrets file")

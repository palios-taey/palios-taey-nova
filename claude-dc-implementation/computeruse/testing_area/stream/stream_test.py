#!/usr/bin/env python3
"""
Basic Streaming Test - Isolated Testing
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('streaming_test.log'),
        logging.StreamHandler()
    ]
)
logger = logging.getLogger('claude_dc.test.streaming')
...
async def test_basic_streaming():
    ...
    prompt = "Hello! Please provide a short explanation of how streaming works in AI systems."
    ...
    # Set up API params - avoiding beta flags
    api_params = {
        "max_tokens": 4096,
        "messages": messages,
        "model": "claude-3-7-sonnet-20250219",  # Using the specified model
        "stream": True
    }
    ...
    try:
        ...
        with open('streaming_output.txt', 'w') as f:

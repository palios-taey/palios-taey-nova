...
if ! python -c "import sys; sys.path.append('$SOURCE_DIR'); import loop, streamlit; from models import tool_models; from tools import registry, bash, edit, computer; from utils import streaming, error_handling"; then
...
echo "To verify, run: cd $TARGET_DIR && python -c 'import loop, streamlit; print(\"Import check passed\")'"
echo "To run the application: cd $TARGET_DIR && streamlit run streamlit.py"

#!/usr/bin/env python3
"""
Tool streaming test for the streaming implementation.

This script tests the basic streaming functionality with tool use.
"""
...
logger = logging.getLogger("tool_streaming_test")
...
async def test_tool_streaming(api_key=None, model="claude-3-sonnet-20240229"):
    """Run a test of streaming with tool use."""
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Test tool streaming functionality")
